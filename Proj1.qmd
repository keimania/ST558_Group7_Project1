...
The goal of this project is to create some functions to query the PUMS census API, and then to summarize and visualize queries. We would also like to investigate a question of interest at the end, using our new functions.
