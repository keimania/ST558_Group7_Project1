...
The goal of this project is to create some functions to query the PUMS census API, and then to summarize and visualize queries. After building these functions, we will then use them to investigate the relationship between location, gross rent as a percentage of income, and sex.
...
Furthermore, we will also allow the user to specify an optional argument to subset the data.
...
Second, we build functions to calculate the time midpoint from 'JWAP' and 'JWDP' columns.
