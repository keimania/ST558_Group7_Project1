...
-   The following code is trying to get the boxplot to work, as specified in the project instructions. The box plot comes out looking really odd, so I've tried to get boxplots to work below this, by modifying the code that was given to us.
...
ggplot(plt_tbl, aes(x = get(cat_var), y = get(num_var), weight = PWGTP)) +
  geom_boxplot()
}
}
```
